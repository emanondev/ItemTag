...
public class IsDuskConditionType extends PlayerRelativeConditionType {

    public IsDuskConditionType() {
        super("is_dusk", EntityDamageEvent.class);
    }
    ...
    protected boolean getCurrentValue(@NotNull Player player, @NotNull ItemStack item, @Nullable Event event, boolean playerRelative) {
        ...
        if (ticks < 0)
            ticks += 24000;
        return ticks >= 13000L && ticks < 14000L;
    }
